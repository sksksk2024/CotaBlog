...
<article className="w-[100dvw] px-4 md:px-8 py-12 mx-auto flex flex-col gap-1 text-white">
      <header className="text-start min-w-container-300 w-[100%] max-w-container-600 mx-auto">
        ...
        <p className="relative -top-48I text-sm text-gray-300">Published on May 4, 2025</p>
      </header>

      <section className="text-lg min-w-container-300 w-[100%] max-w-container-600 leading-relaxed mx-auto">
        <span>I write this blog for mainly hard working people that struggle, and know deep down they could do better.</span>
      ...
      <section className="min-w-container-300 w-[100%] max-w-container-600 mx-auto">

  <h2 className="text-xl font-semibold mb-4">Watch the Video</h2>
  <video controls className="w-full rounded-xl shadow-lg">
    <source src="/videos/calisthenics.mp4" type="video/mp4" />
