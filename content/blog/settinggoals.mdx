...
<article className="w-[100dvw] px-4 md:px-8 py-12 mx-auto flex flex-col gap-1 text-white">
      <header className="text-start min-w-container-300 w-[100%] max-w-container-600 mx-auto">
        ...
        <p className="relative -top-48I text-sm text-gray-300">Published on May 11, 2025</p>
      </header>
      ...
      <section className="text-lg min-w-container-300 w-[100%] max-w-container-600 leading-relaxed mx-auto">
        ...
        <p>
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>I completed The Tower Of Hell (180 levels at the time, now 330)</li>
  ...
  <video controls className="w-full rounded-xl shadow-lg">
    <source src="/videos/settinggoals.mp4" type="video/mp4" />
